...
//use different package to not collide with JDBCQueryTool in official mckoi jar
package util;

//msg04222.html
/*
patch for ctrl-enter in query tool

    To: <mckoidb@xxxxxxxxx>
    Subject: patch for ctrl-enter in query tool
    From: noel@xxxxxxxxxxxx (Noel Grandin)
    Date: Fri, 26 Sep 2003 08:36:28 +0200
    Delivered-To: mailing list mckoidb@mckoi.com
    Mailing-List: contact mckoidb-help@mckoi.com; run by ezmlm
    References: <bkqh6a$7ia$1@sea.gmane.org> <3F70CE9C.4040806@mckoi.com>

*/
//add ctrl+enter keylistener to trigger execute query
//based on original file mckoi1.0.6/src/com/mckoi/tools/JDBCQueryTool.java
...
public class JDBCQueryToolSimple extends JComponent {
   ...
   */
  public JDBCQueryToolSimple(QueryAgent in_query_agent) {
	...
	final ActionListener queryExecuteAction = new ActionListener()
	{
		public void actionPerformed(ActionEvent evt)
		{
			...
			{
				JOptionPane.showMessageDialog(JDBCQueryToolSimple.this,
	...
	query_text_area.addKeyListener(new KeyListener()
	{
		...
		public void keyPressed(KeyEvent e)
		{
			...
			{
				queryExecuteAction.actionPerformed(null);
			}
		}
...
*/
   ...
   * Constructs the JComponent.
   */
  public JDBCQueryToolSimple(Connection connection) {
  ...
  public static void createNewWindow(final Connection connection,
    ...
    JDBCQueryToolSimple query_tool = new JDBCQueryToolSimple(query_agent);
  ...
  private static void printSyntax() {
    System.out.println("JDBCQueryToolSimple [-jdbc JDBC_Driver_Class] [-url JDBC_URL] -u username -p password");
  }
