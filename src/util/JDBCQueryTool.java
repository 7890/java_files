...
/*
This file (JDBCQueryTool.java) is from mckoi1.0.6/contrib directory.
It's not included in the official mckoi jar.
Instead of putting it into the mckoi jar, it's put here for convenience.
